...
>(({ className, enableDrag = true, ...props }, ref) => {
  ...
  return (
    <button
      ...
      className={cn(
        "absolute inset-y-0 z-20 hidden w-2 -translate-x-1/2 transition-all ease-linear after:absolute after:inset-y-0 after:left-1/2 after:w-[2px] hover:after:bg-blue-500 group-data-[side=left]:-right-4 group-data-[side=right]:left-0 sm:flex",
